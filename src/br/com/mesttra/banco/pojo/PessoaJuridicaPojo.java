...
public class PessoaJuridicaPojo extends ClientePojo {
  ...
  public PessoaJuridicaPojo(String cnpj,  String razaoSocial, String nomeFantasia, String numeroConta, int agencia, String telefone, double saldo, double limiteCheque) {
